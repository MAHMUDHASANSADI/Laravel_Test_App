    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 col-12 d-flex bg-primary p-0">
                <img src="{{ asset('assets/guest/images/services/undraw_Online_page_re_lhgx.svg') }}"
                    class="img-fluid services-image" alt="">
            </div>
            ...
            <div class="col-lg-4 col-12 d-flex bg-warning p-0">
                <img src="{{ asset('assets/guest/images/services/undraw_online_transactions_02ka.svg') }}"
                    class="img-fluid services-image" alt="">
            </div>
            ...
            <div class="col-lg-4 col-12 d-flex bg-success p-0 order-lg-0 order-sm-4">
                <img src="{{ asset('assets/guest/images/services/undraw_content_team_3epn.svg') }}"
                    class="img-fluid services-image" alt="">
            </div>
